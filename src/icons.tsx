...
export function SystemIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      width="18px"
      height="18px"
...
export function ColorPicker(props: ComponentProps<"svg">) {
  return (
    <svg
      width="20px"
      height="20px"
...
export function DraggableIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      width="17px"
      height="20px"
      ...
      color="currentcolor"
    >
      <g id="draggable" transform="translate(5,4)">
        <circle cx="1" cy="1" r="1.48" fill="currentcolor" />
        <circle cx="1" cy="6.5" r="1.48" fill="currentcolor" />
        <circle cx="1" cy="12" r="1.48" fill="currentcolor" />
        <circle cx="6.3" cy="1" r="1.48" fill="currentcolor" />
        <circle cx="6.3" cy="6.5" r="1.48" fill="currentcolor" />
        <circle cx="6.3" cy="12" r="1.48" fill="currentcolor" />
      </g>
    </svg>
  );
}

export function ComputerIcon(props: ComponentProps<"svg">) {
  return (
    <svg
      width="24px"
      height="24px"
